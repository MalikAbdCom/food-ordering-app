...
export function ItemLists() {
    ...
    return (
        <div className={' grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-8 py-16 w-11/12 xl:w-full max-w-screen-xl mx-auto'}>
            {
                dataMakanan.map((menu)=>{
                    return (
                        <div className={'rounded-xl bg-slate-200 border border-slate-600 overflow-hidden'}>
                            <img className={'h-[20rem] object-cover'} src={`http://localhost:3000/${menu.image}`} alt={menu.name} />
                            <div className={'p-4'}>
                                <div>
